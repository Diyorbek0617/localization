    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Expanded(
            child: Center(
              child: Text("welcome",style: TextStyle(fontSize: 25,color: Colors.black,),).tr(),
            ),
          ),
          Row(
            children: [
              ...
              Expanded(child: FlatButton(
                ...
                color: Colors.orange,
                child: Text("Japanese",style: TextStyle(color: Colors.white,fontSize: 11,fontWeight: FontWeight.bold),),
              ),),
            ],
          ),
        ],
